...
var Glimmer = /*#__PURE__*/function (_NativeCurrency) {
  _inheritsLoose(Glimmer, _NativeCurrency);

  function Glimmer(chainId) {
    return _NativeCurrency.call(this, chainId, 18, 'GLMR', 'Glimmer') || this;
  }

  Glimmer.onChain = function onChain(chainId) {
    var _this$_cache$chainId;

    return (_this$_cache$chainId = this._cache[chainId]) != null ? _this$_cache$chainId : this._cache[chainId] = new Glimmer(chainId);
  };

  var _proto = Glimmer.prototype;

  _proto.equals = function equals(other) {
    return other.isNative && other.chainId === this.chainId;
  };

  _proto.sortsBefore = function sortsBefore() {
    return false;
  };

  _createClass(Glimmer, [{
    key: "wrapped",
    get: function get() {
      var weth9 = WETH9[this.chainId];
      !!!weth9 ? process.env.NODE_ENV !== "production" ? invariant(false, 'WRAPPED') : invariant(false) : void 0;
...
export { CurrencyAmount, Ether, Fraction, Glimmer, MaxUint256, NativeCurrency, Percent, Price, Rounding, SupportedChainId, Token, TradeType, WETH9, computePriceImpact, sortedInsert, sqrt, validateAndParseAddress };
